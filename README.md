...
| [count_loan_repayment_events_31_60](lib/count_loan_repayment_events)         | count of loan repayment events across all accounts over 31-60 days                                                                     |
| [count_loan_repayment_events_61_90](lib/count_loan_repayment_events)         | count of loan repayment events across all accounts over 61-90 days                                                                     |
...
| [count_missed_payment_events_31_60](lib/count_missed_payment_events)         | count of missed scheduled pyament events across all accounts over 31-60 days                                                           |
| [count_missed_payment_events_61_90](lib/count_missed_payment_events)         | count of missed scheduled pyament events across all accounts over 61-90 days                                                           |
...
| [count_loan_repaid_events_31_60](lib/count_loan_repaid_events)               | count of loan fully repaid events across all accounts over 31-60 days                                                                  |
| [count_loan_repaid_events_61_90](lib/count_loan_repaid_events)               | count of loan fully repaid events across all accounts over 61-90 days                                                                  |
...
| [count_loan_defaulted_events_31_60](lib/count_loan_defaulted_events)         | count of loan defaulted events across all accounts over 31-60 days                                                                     |
| [count_loan_defaulted_events_61_90](lib/count_loan_defaulted_events)         | count of loan defaulted events across all accounts over 61-90 days                                                                     |
...
| [average_of_loan_balances_31_60](lib/average_of_loan_balances)                         | average balance across all loan accounts over 31-60 days                                                                                  |
| [average_of_loan_balances_61_90](lib/average_of_loan_balances)                         | average balance across all loan accounts over 61-90 days                                                                                  |

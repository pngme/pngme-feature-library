...
def get_count_insufficient_funds_events(
...
if __name__ == "__main__":
    ...
    count_insufficient_funds_events_0_30 = get_count_insufficient_funds_events(
        api_client=client,
        user_uuid=user_uuid,
        utc_starttime=now_less_30,
        utc_endtime=now,
    )
    count_insufficient_funds_events_31_60 = get_count_insufficient_funds_events(
        api_client=client,
        user_uuid=user_uuid,
        utc_starttime=now_less_60,
        utc_endtime=now_less_30,
    )
    count_insufficient_funds_events_61_90 = get_count_insufficient_funds_events(
        api_client=client,
        user_uuid=user_uuid,

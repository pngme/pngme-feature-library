...
async def get_count_loan_repayment_events(
    ...
    """
    Count events labelled with LoanRepayment across all institutions
    ...
    # if no data available for the user, assume count of LoanRepayment event is zero
    ...
    count_loan_repayment_events_0_30 = len(record_df[filter_0_30])
    count_loan_repayment_events_31_60 = len(record_df[filter_31_60])
    count_loan_repayment_events_61_90 = len(record_df[filter_61_90])
...
if __name__ == "__main__":
    ...
    async def main():
        (
            ...
            count_loan_repayment_events_31_60,
            count_loan_repayment_events_61_90,
        ) = await get_count_loan_repayment_events(client, user_uuid, now)

        print(count_loan_repayment_events_0_30)
        print(count_loan_repayment_events_31_60)
        print(count_loan_repayment_events_61_90)

...
def get_sum_of_minimum_balances(
...
if __name__ == "__main__":
    ...
    sum_of_minimum_balances_0_30 = get_sum_of_minimum_balances(
        api_client=client,
        user_uuid=user_uuid,
        utc_starttime=decision_time_less_30,
        utc_endtime=decision_time,
    )
    sum_of_minimum_balances_31_60 = get_sum_of_minimum_balances(
        api_client=client,
        user_uuid=user_uuid,
        utc_starttime=decision_time_less_60,
        utc_endtime=decision_time_less_30,
    )
    sum_of_minimum_balances_61_90 = get_sum_of_minimum_balances(
        api_client=client,
        user_uuid=user_uuid,

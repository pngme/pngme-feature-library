#!/usr/bin/env python3
"""
Sums of loan declined events for a given user over all institutions.
...
def count_loan_declined_events(
    ...
    """
    Calculates the sum of all events labelled with LoanDeclined, across all institutions.
    ...
    for individual_account in account_details:
        ...
        record_list.extend([dict(record) for record in loan_declined_events])
...
if __name__ == "__main__":
    ...
    count_loan_declined_events_0_30 = count_loan_declined_events(client, USER_UUID, now_less_30, now)
    count_loan_declined_events_31_60 = count_loan_declined_events(client, USER_UUID, now_less_60, now_less_30)
    count_loan_declined_events_61_90 = count_loan_declined_events(client, USER_UUID, now_less_90, now_less_60)
